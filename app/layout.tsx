...
export const metadata: Metadata = {
  ...
  /* ── SEO core ── */
  title: {
    default: 'GateVerse | جولات افتراضية ثلاثية الأبعاد — الإسكندرية، مصر',
    template: '%s | GateVerse',
  },
  description:
    'GateVerse: جولات افتراضية ثلاثية الأبعاد بتقنية Matterport للعقارات السكنية والتجارية في الإسكندرية ومصر. استضافة $30 شهريًا لأي جولة. تسليم خلال 48 ساعة.',
  keywords: [
    'جولة افتراضية',
  ...
  openGraph: {
    ...
    description:
      'جولات افتراضية ثلاثية الأبعاد بتقنية Matterport للعقارات في الإسكندرية. $30/شهر.',
  },
  ...
  twitter: {
    ...
    description: 'جولات افتراضية بتقنية Matterport في الإسكندرية، مصر. $30/شهر.',
    creator: '@gateverse',
  },
